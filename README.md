...
For detailed information about game mechanics:
- [Link Cost Calculations](docs/LINK_COST_CALCULATIONS.md) - Comprehensive guide to how flight costs are calculated (fuel, crew, fees, depreciation, compensation, lounge, inflight, maintenance)
